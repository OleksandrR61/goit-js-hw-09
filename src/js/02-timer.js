...
Notify.info("To set the detonator timer, select the detonation date and move to a safe distance. If you do not have time to move to a safe distance, just set a new date.", {messageMaxLength: 200, position: 'center-top', timeout: 15000});
